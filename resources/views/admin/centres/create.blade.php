                    ...
                    <div class="row">
                      <div class="col-12 col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" name="name" placeholder="Enter Centre name" required>
                        </div>

                          <div class="form-group">
                            <label >Centre code</label>
                            <input type="text" class="form-control" name="code" id="code" rows="3" placeholder="Enter centre code" required> 
                          </div>   
